    ...
    protected $message
        = array(
            'headers' => array(
                ...
                'chown' => null, # chord
                'retries' => null,
                'timelimit' => null # (time_limit, soft_time_limit)
            ),
            'properties' => array(
                'correlation_id' => null,
                'reply_to' => null
            ...
            'sent_event' => array( # Not sure any of this will be used yet for sending but perhaps receiving
                'uuid' => null,
                'name' => null,
                'args' => null, # safe_repr(args)
                'kwargs' => null, # safe_repr(kwargs)
                'retries' => null,
                'eta' => null,
                'expires' => null
